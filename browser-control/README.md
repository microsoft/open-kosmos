...
Browser control suite for [OpenKosmos](https://github.com/anthropics/kosmos). Exposes Chrome browser capabilities to AI agents via the [Model Context Protocol (MCP)](https://modelcontextprotocol.io/), enabling browser automation, content analysis, and interaction — all within the user's existing browser session.
