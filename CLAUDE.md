...
- Dev runs write per-launch logs named `kosmos-dev-YYYY-MM-DD-HH-mm-ss.log` in the normal app logs directory; production runs continue to use daily `kosmos-YYYY-MM-DD.log` files.
...
## Contact
For development access or questions, contact: https://github.com/the7thfreedom/kosmos-open-source/issues
