...
`src/main/lib/chat/agentChat.ts` is the core main-process chat engine for OpenKosmos agent conversations. It currently owns multiple responsibilities at once:
...
3. Knowledge base and workspace prompt sections.
