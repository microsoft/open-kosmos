...
- openkosmos (this project) is a general-purpose agent, which differs somewhat from Claude Code
- Sub-agents can be configured in the openkosmos (this project) settings page, similar to how skills are configured
...
- openkosmos (this project) sub-agent tasks can also run in parallel.
- Technical documentation should be generated based on the current openkosmos (this project) technical architecture
