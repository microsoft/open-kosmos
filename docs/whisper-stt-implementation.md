...
This document describes how to implement Speech-to-Text (STT) functionality in OpenKosmos Studio using OpenAI Whisper running locally.
...
For OpenKosmos Studio, we recommend **Option A (whisper.cpp)** with the following architecture:
