...
>
> **Parent Document**: [`docs/openkosmos-sub-agent-tech-doc.md`](./openkosmos-sub-agent-tech-doc.md) (§4.2 SubAgentChat, §4.3 spawn_subagent, §5.3 ChatView Sub-Agent State Display)
>
> **Scope**: This document is a sub-document of `openkosmos-sub-agent-tech-doc.md`, focusing on **real-time UI display of Sub-Agent runtime progress information** (Approach A: Extending `subAgent:stateUpdate` IPC)
>
...
| This Document Section | Parent Document `openkosmos-sub-agent-tech-doc.md` Section |
|-----------|-------------------------------------------|
