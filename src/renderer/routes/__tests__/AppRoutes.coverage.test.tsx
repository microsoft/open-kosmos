...
vi.mock('../lib/featureFlags', () => ({
  useFeatureFlag: (flag: string) => {
    ...
    if (flag === 'kosmosFeatureRemoteChannel') return mockRemoteChannelEnabled();
    if (flag === 'kosmosFeatureSubAgent') return mockSubAgentEnabled();
    if (flag === 'kosmosFeaturePlugins') return mockPluginsEnabled();
    return false;
  },
}));
