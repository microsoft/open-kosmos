...
const {
  ...
  const mockBrandName = { value: 'openkosmos' };
...
describe('NavigationSection — basic render (openkosmos)', () => {
...
describe('NavigationSection — handleNewAgent (openkosmos)', () => {
...
describe('NavigationSection — builtin agents (openkosmos)', () => {
