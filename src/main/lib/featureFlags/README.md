...
| `brandName` | string | Current brand (`openkosmos`) |
...
# macOS
./OpenKosmos.app/Contents/MacOS/OpenKosmos --enable-features=openkosmosFeatureDevTools
...
| `openkosmosFeatureExperimentalChat` | Experimental chat | `(ctx) => ctx.isDev` |
