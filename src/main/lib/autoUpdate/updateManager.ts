...
export class UpdateManager {
   ...
   *   e.g. C:\Users\xxx\AppData\Local\Programs\openkosmos
   *
  ...
  private silentUpdate(zipPath: string): void {
    try {
      ...
      // Example paths:
      //   Windows: C:\Users\xxx\AppData\Roaming\openkosmos-app\assets\updater\updater-win-x64.exe
      //   macOS:   ~/Library/Application Support/openkosmos-app/assets/updater/updater-mac-arm64
   ...
   *   Example:      C:\Users\xxx\AppData\Local\Programs\openkosmos
   *   Notes:
  ...
  private getAppInstallPath(): string {
    ...
    if (process.platform === 'darwin') {
      ...
      // BRAND_NAME is injected by webpack at build time (e.g. "openkosmos")
      const brandName = BRAND_NAME || 'openkosmos';
