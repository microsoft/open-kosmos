/**
 * FetchWebContentTool built-in tool - modeled after readFileTool
 * Provides LLM-initiated web content fetching capability, supporting parallel fetching and text extraction
