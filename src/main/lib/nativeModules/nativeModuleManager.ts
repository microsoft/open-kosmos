 ...
 * These modules (whisper-node-addon) are not distributed with
 * the application installer; instead they are downloaded from the npm CDN and
 * cached in the userData directory the first time the user activates the
