...
describe('electronAPI.kosmos', () => {
  ...
  it('replacePlaceholders', () => {
    electronAPI.kosmos.replacePlaceholders({ KEY: 'val' });
    expect(mockInvoke).toHaveBeenCalledWith('kosmos:replacePlaceholders', { KEY: 'val' });
  });

  it('parseUserInputPlaceholders', () => {
    electronAPI.kosmos.parseUserInputPlaceholders({ env: {} });
    expect(mockInvoke).toHaveBeenCalledWith('kosmos:parseUserInputPlaceholders', { env: {} });
  });
});
