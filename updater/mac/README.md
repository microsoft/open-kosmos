...
Log file location: `/tmp/openkosmos-updater.log`

View logs:
```bash
cat /tmp/openkosmos-updater.log
# or
tail -f /tmp/openkosmos-updater.log  # Watch in real-time
```
...
1. Check `/tmp/openkosmos-updater.log` for errors
