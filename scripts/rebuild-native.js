#!/usr/bin/env node
/**
 * Automatically detect the Electron version and rebuild native modules.
 * Fixes the issue where the postinstall phase cannot detect the Electron version in CI/CD.
 */
