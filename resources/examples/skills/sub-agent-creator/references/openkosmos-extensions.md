...
All OpenKosmos-specific fields are placed under the `x-openkosmos` key in the YAML front-matter to ensure interoperability with the Claude Code sub-agent specification.
...
| `x-openkosmos:` namespace | ❌ (ignored) | ✅ | OpenKosmos extensions |
