...
If Node.js is not installed, install a supported release from [nodejs.org](https://nodejs.org/).
...
**Solution**:
1. Ensure Node.js and npm are installed from [nodejs.org](https://nodejs.org/)
